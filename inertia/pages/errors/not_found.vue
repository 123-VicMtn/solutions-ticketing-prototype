...
<template>
  ...
  <CenteredContent maxWidthClass="max-w-md">
    <div class="mb-6 text-center">
      <p class="text-sm font-semibold text-muted">404</p>
      <h1 class="mt-2 text-2xl font-bold tracking-tight text-base-content">Page introuvable</h1>
      <p class="mt-1 text-sm text-muted">La page que vous cherchez n'existe pas.</p>
    </div>
